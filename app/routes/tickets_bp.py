...
tickets_bp.route("/tickets/<int:ticket_id>/update", methods=["GET", "POST"])(tickets_update)
tickets_bp.route("/tickets/<int:ticket_id>/delete", methods=["POST"])(tickets_delete)
